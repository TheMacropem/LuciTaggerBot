...
api_id = int(os.environ.get("11346532"))
api_hash = os.environ.get("ef5d453c949d00ff56908d467fdcf31b")
bot_token = os.environ.get("5739504972:AAFXkEnWUD5Qt05Y8kHrQCVVEAiZ6Y1SQjk")
...
💬 Ben, kuruluşunuzdaki kullanıcıları davet etmeniz için oluşturulmuş çok işlevli bir botum

✅ Botu nasıl kullanacağınızı öğrenmek için

/help komutunu kullanın",
                    buttons=(
                   
		      [Button.url('Beni Gruba Ekle ➕', 'https://t.me/miss_lunabot?startgroup=a')],
                      [Button.url('Support🛠', 'https://t.me/DarkwebCrusadersTeam')],
                      [Button.url('Resmi Kanal📣', 'https://t.me/AlignakZona')],
		      [Button.url('Developer👨🏻‍💻', 'https://t.me/TheMacroPem')],
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**🌀 @Miss_LunaBot Komutları**\n\n**/tag <sebeb> - 5-li Etiket Atar**\n\n**/etag <sebeb> - Emoji ile etiketler**\n\n**/tektag sebeb - Üyeleri Tek Tek Etiketler**\n\n**/admins sebeb - Yöneticileri Tek Tek Tag Eder**\n\n**/start - botu başlatır**"
...
async def help(event):
  helptext = "**Çok özellikleri Etiket Botu Bulmaya Çalışan Grub Sahibleri @miss_LunaBot Size Göre:\n\n📌 5-li etiket\n📌 Emoji etiket\n📌 Tekli Etiket\n📌 Yalnız Yöneticileri etiketleme\n📌\n\n Böyle Çok özellikli @LuciTaggerBot 'u grubunuza yönetici olarak ekleyip rahatlıkla üyelir , etiket ata bilirsiz **"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Botu Gruba Ekle➕', 'https://t.me/miss_Lunabot?startgroup=a')],
                    ),
                    link_preview=False
                   )
